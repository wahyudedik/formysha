    ...
    <div class="py-12">
        <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-soft sm:rounded-3xl p-4 sm:p-6 lg:p-8">
                ...
                <form method="POST" action="{{ route('family.update', [$child, $familyMember]) }}" class="space-y-6" x-data="{ loading: false }" @submit="loading = true">
                    @csrf
                    @method('PUT')
                    ...
                    <div>
                        ...
                        <x-text-input id="name" name="name" type="text" class="mt-1 block w-full" :value="old('name', $familyMember->name)" required />
                    ...
                    <div>
                        ...
                        <select id="relationship" name="relationship" class="mt-1 block w-full border-gray-300 focus:border-softPink-300 focus:ring-softPink-200 rounded-xl shadow-sm transition dark:border-gray-600 dark:bg-gray-700 dark:text-gray-200" required>
                            ...
                            <option value="guardian" {{ old('relationship', $familyMember->relationship) === 'guardian' ? 'selected' : '' }}>🤝 Wali</option>
                            ...
                            <option value="sibling" {{ old('relationship', $familyMember->relationship) === 'sibling' ? 'selected' : '' }}>🧒 Saudara/i</option>
                    ...
                    <div>
                        ...
                        <x-text-input id="phone" name="phone" type="tel" class="mt-1 block w-full" :value="old('phone', $familyMember->phone)" />
