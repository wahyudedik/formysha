    ...
    <div class="py-12">
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-soft sm:rounded-3xl p-6 sm:p-8">
                <div class="mb-6">
                    <h3 class="text-lg font-medium text-gray-900">{{ __('Edit Profil Anak') }}</h3>
                ...
                <form method="POST" action="{{ route('children.update', $child) }}" enctype="multipart/form-data" class="space-y-6">
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <input type="checkbox" id="is_public" name="is_public" value="1" {{ old('is_public', $child->is_public) ? 'checked' : '' }} class="rounded border-gray-300 text-softPink-300 focus:ring-softPink-200">
