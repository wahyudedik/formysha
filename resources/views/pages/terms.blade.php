<x-pages-layout :page-title="'Syarat & Ketentuan'">
    <div class="prose max-w-none">
        <p class="text-sm text-gray-400 dark:text-gray-500 mb-6">Terakhir diperbarui: {{ date('d F Y') }}</p>

        <h2 class="text-xl font-bold text-gray-800 dark:text-gray-100 mt-8 mb-3">1. Penerimaan Syarat</h2>
        ...
        <h2 class="text-xl font-bold text-gray-800 dark:text-gray-100 mt-8 mb-3">2. Akun Pengguna</h2>
        <p class="text-gray-600 dark:text-gray-300 leading-relaxed mb-4">
        ...
        <h2 class="text-xl font-bold text-gray-800 dark:text-gray-100 mt-8 mb-3">3. Penggunaan Layanan</h2>
        <p class="text-gray-600 dark:text-gray-300 leading-relaxed mb-4">
        ...
        <h2 class="text-xl font-bold text-gray-800 dark:text-gray-100 mt-8 mb-3">4. Kepemilikan Konten</h2>
        <p class="text-gray-600 dark:text-gray-300 leading-relaxed mb-4">
        ...
        <h2 class="text-xl font-bold text-gray-800 dark:text-gray-100 mt-8 mb-3">5. Pembatalan & Penghapusan</h2>
        <p class="text-gray-600 dark:text-gray-300 leading-relaxed mb-4">
        ...
        <h2 class="text-xl font-bold text-gray-800 dark:text-gray-100 mt-8 mb-3">6. Perubahan Syarat</h2>
        <p class="text-gray-600 dark:text-gray-300 leading-relaxed mb-4">
