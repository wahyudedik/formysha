<x-pages-layout :page-title="'Kebijakan Privasi'">
    <div class="prose max-w-none">
        ...
        <h2 class="text-xl font-bold text-gray-800 dark:text-gray-100 mt-8 mb-3">1. Pengumpulan Informasi</h2>
        ...
        <h2 class="text-xl font-bold text-gray-800 dark:text-gray-100 mt-8 mb-3">2. Penggunaan Informasi</h2>
        <p class="text-gray-600 dark:text-gray-300 leading-relaxed mb-4">
        ...
        <h2 class="text-xl font-bold text-gray-800 dark:text-gray-100 mt-8 mb-3">3. Keamanan Data</h2>
        <p class="text-gray-600 dark:text-gray-300 leading-relaxed mb-4">
        ...
        <h2 class="text-xl font-bold text-gray-800 dark:text-gray-100 mt-8 mb-3">4. Berbagi Data</h2>
        <p class="text-gray-600 dark:text-gray-300 leading-relaxed mb-4">
        ...
        <h2 class="text-xl font-bold text-gray-800 dark:text-gray-100 mt-8 mb-3">5. Hak Anda</h2>
        <p class="text-gray-600 dark:text-gray-300 leading-relaxed mb-4">
