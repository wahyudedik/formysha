            ...
            <div class="flex-1 min-w-0">
                ...
                @if ($plan)
                    <div class="bg-gradient-to-r from-skyBlue-50 to-lavender-50 rounded-2xl shadow-soft p-6 mb-6 border border-skyBlue-100">
                        <div class="flex items-center justify-between">
                            <div>
                                <h3 class="font-semibold text-gray-800">Paket: {{ $plan->name }}</h3>
                                <p class="text-sm text-gray-500">{{ $plan->getPriceMonthlyFormatted() }}/bulan</p>
                            </div>
                            <span class="inline-flex items-center px-3 py-1 rounded-lg text-sm font-medium bg-mintGreen-100 text-mintGreen-700">
                                ✅ Aktif
                            </span>
                        </div>
                    </div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    ...
                    <div class="bg-white rounded-2xl shadow-soft p-6 border border-gray-100">
                        <div class="flex items-center gap-3 mb-4">
                            ...
                            <div>
                                <h3 class="font-semibold text-gray-800">Anak</h3>
                        ...
                        @else
                            <p class="text-xs text-mintGreen-600 mt-2">♾️ Unlimited</p>
                        @endif
                    </div>
                    ...
                    <div class="bg-white rounded-2xl shadow-soft p-6 border border-gray-100">
                        <div class="flex items-center gap-3 mb-4">
                            ...
                            <div>
                                <h3 class="font-semibold text-gray-800">Foto</h3>
                                <p class="text-sm text-gray-500">
                    ...
                    <div class="bg-white rounded-2xl shadow-soft p-6 border border-gray-100">
                        <div class="flex items-center gap-3 mb-4">
                            ...
                            <div>
                                <h3 class="font-semibold text-gray-800">Penyimpanan</h3>
                                <p class="text-sm text-gray-500">
                                    @if ($maxStorageMb === -1)
                ...
                @if ($plan && ($childrenCount / max($maxChildren, 1) > 0.8 || $photoCount / max($maxPhotos, 1) > 0.8 || $videoCount / max($maxVideos, 1) > 0.8 || ($maxStorageMb > 0 && $storageUsed / $maxStorageBytes > 0.8)))
                    <div class="mt-6 bg-gradient-to-r from-warmYellow-50 to-peach-50 rounded-2xl shadow-soft p-6 border border-warmYellow-100">
                        <div class="flex items-center gap-4">
                            <div class="w-12 h-12 rounded-xl bg-warmYellow-100 flex items-center justify-center shrink-0">
                                <span class="text-2xl">⬆️</span>
                            </div>
                            <div class="flex-1">
                                <h3 class="font-semibold text-gray-800">Mendekati Batas?</h3>
                                <p class="text-sm text-gray-600">Paket Anda hampir mencapai batas. Upgrade untuk mendapatkan lebih banyak ruang dan fitur.</p>
                            </div>
                ...
                {{-- No Plan CTA --}}
                @if (! $plan)
                    <div class="mt-6 bg-gradient-to-r from-skyBlue-50 to-lavender-50 rounded-2xl shadow-soft p-6 border border-skyBlue-100">
                        <div class="flex items-center gap-4">
                            <div class="w-12 h-12 rounded-xl bg-skyBlue-100 flex items-center justify-center shrink-0">
                                <span class="text-2xl">📋</span>
                            </div>
                            <div class="flex-1">
                                <h3 class="font-semibold text-gray-800">Belum Ada Paket</h3>
                                <p class="text-sm text-gray-600">Pilih paket langganan untuk mulai menggunakan ForMysha.</p>
                            </div>
                            <a href="{{ route('subscription.plans') }}" class="shrink-0 btn-primary text-sm">
                                Lihat Paket
                            </a>
