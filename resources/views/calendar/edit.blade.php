<x-app-layout>
    <x-slot name="header">
        <div>
            <a href="{{ route('calendar.show', [$child, $event]) }}" class="text-sm text-skyBlue-600 hover:text-skyBlue-700 transition">
            ...
            <div class="p-6 sm:p-8">
                <form method="POST" action="{{ route('calendar.update', [$child, $event]) }}">
                    ...
                    <div class="mb-5">
                        ...
                        <textarea id="description" name="description" rows="3" class="mt-1 block w-full border-gray-300 focus:border-skyBlue-500 focus:ring-skyBlue-500 rounded-2xl shadow-soft">{{ old('description', $event->description) }}</textarea>
                    ...
                    <div class="flex items-center gap-3">
                        <a href="{{ route('calendar.show', [$child, $event]) }}" class="btn-secondary">
                            Batal
                        </a>
