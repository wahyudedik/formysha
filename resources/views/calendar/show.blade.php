<x-app-layout>
    ...
    <div class="py-8 max-w-3xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-soft sm:rounded-3xl">
            <!-- Header -->
            <div class="p-6 sm:p-8 bg-gradient-to-br from-mintGreen-50 to-skyBlue-50 dark:from-mintGreen-950/30 dark:to-skyBlue-950/30 border-b border-mintGreen-100 dark:border-mintGreen-900/30">
            ...
            <div class="p-6 sm:p-8">
                ...
                <!-- Actions -->
                <div class="flex items-center gap-3 mt-8 pt-6 border-t border-gray-100 dark:border-gray-700">
                    ...
                    <button
                        ...
                        class="px-4 py-2 text-sm font-medium text-red-600 dark:text-red-400 bg-red-50 dark:bg-red-950/30 rounded-2xl hover:bg-red-100 dark:hover:bg-red-950/50 transition"
                    >
