        ...
        <div class="bg-white overflow-hidden shadow-soft sm:rounded-3xl">
            <div class="p-6 sm:p-8">
                ...
                <form method="POST" action="{{ route('calendar.store', $child) }}">
                    ...
                    <!-- Child Info -->
                    <div class="mb-6 p-4 rounded-2xl bg-gradient-to-br from-mintGreen-50 to-skyBlue-50 border border-mintGreen-100">
                        <p class="text-sm text-gray-500">{{ __('Acara untuk') }}</p>
                    ...
                    <div class="mb-5">
                        ...
                        <select id="event_type" name="event_type" class="mt-1 block w-full border-gray-300 focus:border-skyBlue-500 focus:ring-skyBlue-500 rounded-2xl shadow-soft" required>
                    ...
                    <div class="mb-5">
                        ...
                        <textarea id="description" name="description" rows="3" class="mt-1 block w-full border-gray-300 focus:border-skyBlue-500 focus:ring-skyBlue-500 rounded-2xl shadow-soft" placeholder="Detail acara...">{{ old('description') }}</textarea>
                    ...
                    <div class="mb-5" x-data="{ isRecurring: {{ old('is_recurring') ? 'true' : 'false' }} }">
                        <label class="flex items-center gap-3 cursor-pointer mb-3">
                            ...
                            <input type="checkbox" name="is_recurring" value="1" x-model="isRecurring" class="rounded border-gray-300 text-skyBlue-500 focus:ring-skyBlue-500">
                            <span class="text-sm text-gray-700">🔁 {{ __('Acara berulang') }}</span>
                        </label>
                        <div x-show="isRecurring" x-transition class="ml-6">
                            <x-input-label for="recurrence_pattern" :value="__('Pola Pengulangan')" />
                            <select id="recurrence_pattern" name="recurrence_pattern" class="mt-1 block w-full border-gray-300 focus:border-skyBlue-500 focus:ring-skyBlue-500 rounded-2xl shadow-soft">
                    ...
                    <div class="flex items-center gap-3">
                        <a href="{{ route('calendar.index', $child) }}" class="btn-secondary">
                            Batal
                        </a>
