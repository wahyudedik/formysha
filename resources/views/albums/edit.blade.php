<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center gap-3">
            <a href="{{ route('albums.show', [$child, $album]) }}" class="text-gray-400 hover:text-gray-600 transition">
            ...
            <div class="bg-white overflow-hidden shadow-soft sm:rounded-3xl">
                <div class="p-6 sm:p-8">
                    ...
                    <div class="flex items-center gap-3 mb-6 p-4 bg-gradient-to-r from-lavender-50 to-softPink-50 rounded-2xl">
                        ...
                        <div>
                            <p class="text-sm text-gray-500">{{ __('Edit album untuk') }}</p>
                    ...
                    <form method="POST" action="{{ route('albums.update', [$child, $album]) }}">
                        ...
                        <div class="mb-5">
                            ...
                            <textarea id="description" name="description" rows="3" class="mt-1 block w-full border-gray-300 focus:border-lavender-500 focus:ring-lavender-500 rounded-2xl shadow-soft">{{ old('description', $album->description) }}</textarea>
                        ...
                        <!-- Submit -->
                        <div class="flex items-center gap-3">
                            <a href="{{ route('albums.show', [$child, $album]) }}" class="btn-secondary">
                                {{ __('Batal') }}
                            </a>
