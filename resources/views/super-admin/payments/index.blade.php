        ...
        <div class="flex flex-col lg:flex-row gap-6">
            ...
            <div class="flex-1 min-w-0">
                                ...
                                @forelse ($payments as $payment)
                                    <tr class="border-b border-gray-50 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-750 transition">
                                        ...
                                        <td class="px-6 py-4 text-right">
                                            <a href="{{ route('super-admin.payments.show', $payment) }}" class="inline-flex items-center px-3 py-1.5 rounded-lg text-xs font-medium bg-skyBlue-50 text-skyBlue-600 hover:bg-skyBlue-100 dark:bg-skyBlue-950/30 dark:text-skyBlue-400 dark:hover:bg-skyBlue-950/50 transition">
                                                Lihat Detail
                                            </a>
                                        </td>
                                    </tr>
                ...
                <div class="md:hidden space-y-3">
                    @forelse ($payments as $payment)
                        <a href="{{ route('super-admin.payments.show', $payment) }}" class="block bg-white dark:bg-gray-800 rounded-2xl shadow-soft p-4 border border-gray-100 dark:border-gray-700">
