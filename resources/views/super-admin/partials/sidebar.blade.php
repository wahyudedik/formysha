...
<aside class="w-full lg:w-64 shrink-0" x-data="{ sidebarOpen: false }">
    ...
    >
        <span class="font-semibold text-gray-800 dark:text-gray-100">{{ __('navigation.admin_menu') }}</span>
    ...
    >
        <div class="p-4 border-b border-gray-100 dark:border-gray-700">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <h3 class="font-bold text-gray-800 dark:text-gray-100 text-sm">{{ __('navigation.super_admin') }}</h3>
                    <p class="text-xs text-gray-500 dark:text-gray-400">{{ __('navigation.admin_panel') }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="p-2">
            ...
            <a
                href="{{ route('super-admin.error-logs.index') }}"
                class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition-colors min-h-[44px] {{ request()->routeIs('super-admin.error-logs.*') ? 'bg-skyBlue-50 dark:bg-skyBlue-950/30 text-skyBlue-600 dark:text-skyBlue-400' : 'text-gray-600 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700 hover:text-gray-800 dark:hover:text-gray-100' }}"
            >
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-2.5L13.732 4c-.77-.833-1.964-.833-2.732 0L4.082 16.5c-.77.833.192 2.5 1.732 2.5z" />
                </svg>
                {{ __('navigation.error_logs') }}
            </a>
