            ...
            <div class="bg-white overflow-hidden shadow-soft sm:rounded-3xl">
                <div class="p-6 sm:p-8">
                    ...
                    <div class="flex items-center gap-3 mb-6 p-4 bg-gradient-to-r from-mintGreen-50 to-skyBlue-50 rounded-2xl">
                        ...
                        <div>
                            <p class="text-sm text-gray-500">{{ __('Edit pengukuran untuk') }}</p>
                    ...
                    <form method="POST" action="{{ route('growth.update', [$child, $growth]) }}">
                        ...
                        <div class="mb-6">
                            ...
                            <textarea id="notes" name="notes" rows="3" class="mt-1 block w-full border-gray-300 focus:border-mintGreen-500 focus:ring-mintGreen-500 rounded-2xl shadow-soft" placeholder="Catatan tambahan tentang pengukuran ini...">{{ old('notes', $growth->notes) }}</textarea>
