            ...
            <div class="bg-white overflow-hidden shadow-soft sm:rounded-3xl">
                <div class="p-6 sm:p-8">
                    ...
                    <div class="flex items-center gap-3 mb-6 p-4 bg-gradient-to-r from-peach-50 to-warmYellow-50 rounded-2xl">
                        ...
                        <div>
                            <p class="text-sm text-gray-500">{{ __('Diary untuk') }}</p>
                    ...
                    <form method="POST" action="{{ route('diaries.store', $child) }}">
                        ...
                        <div class="mb-5">
                            ...
                            <textarea id="content" name="content" rows="8" class="mt-1 block w-full border-gray-300 focus:border-peach-500 focus:ring-peach-500 rounded-2xl shadow-soft" placeholder="Ceritakan tentang hari ini..." required>{{ old('content') }}</textarea>
