    ...
    <div class="py-12">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-soft sm:rounded-3xl">
                ...
                <!-- Media Section -->
                <div class="px-6 sm:px-8 py-6 border-t border-gray-100">
                    <h4 class="text-sm font-medium text-gray-500 mb-3">{{ __('Media / Lampiran') }}</h4>
                    ...
                    @if ($diary->media->isNotEmpty())
                        <div class="grid grid-cols-2 sm:grid-cols-3 gap-3">
                            @foreach ($diary->media as $media)
                                <div class="relative group p-3 bg-gray-50 rounded-2xl text-center">
