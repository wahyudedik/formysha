...
* Wali
* Foto
* Slug unik untuk public profile
...
* Halaman publik berdasarkan slug
* Tampilan timeline, galeri, dan penghargaan
...
* Notifikasi sistem (reminder, info, warning, success)
* Badge counter di navigasi
* Mark as read
* Mark all as read
* Hapus notifikasi
...
* Shared layout component (`x-pages-layout`)

---

## Toast Notifications

* Global toast notification system (`x-toast` component)
* Auto-dismiss setelah 5 detik
* Tipe: success, error, warning, info
* Kompatibel dengan `session('status')` dari controller

---

## Child Ownership Middleware

* Middleware `child.ownership` untuk verifikasi kepemilikan data anak
* Terdaftar di `bootstrap/app.php` sebagai alias
* Diterapkan ke semua route `/children/{child}/*`
* Menggantikan `abort_if` inline di semua controllers

---

## Confirm Delete Modal

* Komponen `x-confirm-delete` untuk konfirmasi hapus data
* Menggunakan Alpine.js custom event
* Props: `id`, `title`, `message`, `action`, `method`
